...
<body>
    <div class="container-sm mt-5">
        <h4 class="text-center">Cadastro de Obras</h4>
        <form action="autor_livro.php" method="post">
            <input type="hidden" name="id_autor_livro" id="id_autor_livro" value="<?=isset($obra) ? $obra->getAutorLivro() : 0?>">
                ...
                <div class="col-3">
                    ...
                    <?php
                       ...
                       foreach($autores as $autor){ 
                           ...
                           if(isset($obra)) 
                               if ($obra->getAutor()->getIdAutor() == $autor->getIdAutor()) 
                                   $str .= " selected ";
